<script setup>
let infoProduct = useInfoProduct();
...
<!-- Правая часть: Итоги -->
    <div class="summary-block">
        ...
        <button class="summary-block__btn summary-block__btn--primary">Оформить заказ</button>
        <button class="summary-block__btn summary-block__btn--secondary">Купить в 1 клик</button>
    </div>
</template>
